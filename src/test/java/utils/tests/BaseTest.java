        ...
        switch (target) {
            case TARGET_BROWSER:
                if (browser.equals(BROWSER_CHROME)) {
                    System.setProperty("webdriver.chrome.driver", "/Users/ljozefowicz/Documents/Webdriver/chromedriver");
                    driver = new ChromeDriver();

                } else if (browser.equals(BROWSER_FIREFOX)) {
                    System.setProperty("webdriver.gecko.driver", "/Users/ljozefowicz/Documents/Webdriver/geckodriver");
